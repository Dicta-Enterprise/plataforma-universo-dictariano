...
export class GalaxiasComponent {
  ...
  galaxia: Galaxias = new Galaxias();
  isNuevaGalaxia: boolean = false;
  galaxiaAEliminar: Galaxias | null = null;
  ...
  editarGalaxia(galaxia: Galaxias) {
    this.galaxia = galaxia;
    this.showNuevaGalaxia();
  }

  confirmarEliminacion(galaxia: Galaxias) {
